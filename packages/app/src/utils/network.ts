import { mainnet, arbitrum, base, polygon, optimism, sepolia, hardhat } from '@reown/appkit/networks'

export const ETH_CHAINS = [mainnet, arbitrum, base, polygon, optimism, sepolia, hardhat]
